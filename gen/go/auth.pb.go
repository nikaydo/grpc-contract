...
func (x *CheckUserResponse) GetUserId() bool {
	if x != nil {
		return x.UserId
	}
	return false
...
const file_auth_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\bR\x06userId2\xae\x01\n" +
	"\x04Auth\x123\n" +
	...
	"\tCheckUser\x12\x16.auth.CheckUserRequest\x1a\x17.auth.CheckUserResponseB'Z%github.com/nikaydo/video-App-grpc;appb\x06proto3"
...
var file_auth_proto_depIdxs = []int32{
	...
	5, // 5: auth.Auth.CheckUser:output_type -> auth.CheckUserResponse
